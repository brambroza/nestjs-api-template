 ...
 * company, warehouse → branch, item → uom) go through a narrow lookup
 * port owned by the consuming module, with a Prisma adapter that reads
 * the other table directly. dependency-cruiser enforces this.
 */
@Module({
  imports: [
    CompanyModule,
