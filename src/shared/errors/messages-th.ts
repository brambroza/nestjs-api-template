...
export const MESSAGES_TH: Readonly<Record<string, string>> = {
  ...
  'AP.REF_INVALID':
    'ข้อมูลอ้างอิง (บริษัท/ผู้ขาย/สินค้า/ใบสั่งซื้อ/รหัสภาษี) ไม่ถูกต้อง',
  'AP.INVOICE_NOT_FOUND': 'ไม่พบใบแจ้งหนี้ผู้ขายที่ระบุ',
  'AP.ILLEGAL_INVOICE_TRANSITION':
    'ไม่สามารถเปลี่ยนสถานะใบแจ้งหนี้ผู้ขายจากสถานะปัจจุบันได้',
  'AP.INVALID_INVOICE': 'ข้อมูลใบแจ้งหนี้ผู้ขายไม่ถูกต้อง',
  'AP.MATCH_VARIANCE':
    'ใบแจ้งหนี้ไม่ตรงกับใบสั่งซื้อ/ใบรับสินค้า ต้องยืนยันรับผลต่างก่อนบันทึก',
  'AP.SETTLEMENT_EXCEEDS_BALANCE': 'ยอดชำระเกินยอดคงค้างของใบแจ้งหนี้ผู้ขาย',
  'AP.VOUCHER_NOT_FOUND': 'ไม่พบใบสำคัญจ่ายที่ระบุ',
  'AP.ILLEGAL_VOUCHER_TRANSITION':
    'ไม่สามารถเปลี่ยนสถานะใบสำคัญจ่ายจากสถานะปัจจุบันได้',
  'AP.INVALID_VOUCHER': 'ข้อมูลใบสำคัญจ่ายไม่ถูกต้อง',
  'AP.BATCH_NOT_FOUND': 'ไม่พบชุดการจ่ายเงินที่ระบุ',
  'AP.INVALID_BATCH': 'ข้อมูลชุดการจ่ายเงินไม่ถูกต้อง',
  'AP.CERTIFICATE_NOT_FOUND': 'ไม่พบหนังสือรับรองการหักภาษี ณ ที่จ่ายที่ระบุ',
  'AP.VERSION_CONFLICT':
    'เอกสารถูกแก้ไขโดยผู้ใช้อื่นแล้ว กรุณาโหลดใหม่แล้วลองอีกครั้ง',
  'GL.REF_INVALID': 'ข้อมูลอ้างอิงของรายการบัญชีไม่ถูกต้อง',
  'GL.ENTRY_NOT_FOUND': 'ไม่พบรายการบัญชี (JV) ที่ระบุ',
  'GL.ILLEGAL_ENTRY_TRANSITION':
    'ไม่สามารถเปลี่ยนสถานะรายการบัญชีจากสถานะปัจจุบันได้',
  'GL.INVALID_ENTRY': 'ข้อมูลรายการบัญชีไม่ถูกต้อง',
  'GL.UNBALANCED_ENTRY': 'ยอดเดบิตและเครดิตของรายการบัญชีไม่เท่ากัน',
  'GL.ACCOUNT_MAPPING_MISSING':
    'ยังไม่ได้กำหนดผังบัญชีสำหรับรายการนี้ กรุณาตั้งค่าบัญชีที่ใช้ลงรายการก่อน',
  'GL.ACCOUNT_NOT_POSTABLE':
    'บัญชีนี้เป็นบัญชีหมวดหรือถูกปิดใช้งาน ไม่สามารถลงรายการได้',
  'GL.APPROVAL_PENDING': 'รายการบัญชีนี้รอการอนุมัติอยู่',
  'GL.VERSION_CONFLICT':
    'รายการบัญชีถูกแก้ไขโดยผู้ใช้อื่นแล้ว กรุณาโหลดใหม่แล้วลองอีกครั้ง',
  'GL.PERIOD_HAS_UNPOSTED_ENTRIES':
    'ยังมีรายการบัญชีที่ยังไม่ได้ผ่านรายการในงวดนี้ กรุณาผ่านรายการหรือยกเลิกก่อนปิดงวด',
  'GL.PERIOD_NOT_FOUND': 'ไม่พบงวดบัญชีที่ครอบคลุมวันที่ระบุ',
  'TAX.REF_INVALID': 'ข้อมูลอ้างอิงของรายงานภาษีไม่ถูกต้อง',
  'TAX.INVALID_PERIOD': 'เดือนภาษีต้องอยู่ในรูปแบบ YYYY-MM',
};
